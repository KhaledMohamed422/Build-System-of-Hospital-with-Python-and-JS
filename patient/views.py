...
def bookAppointment_2(request,slug):
    ...
    if request.method == "POST":
        ...
        Date_Appointment = str_selected_schedule[str_selected_schedule.index('y ')+1:]
        ...
        # create Appointment
        Appointment.objects.create(patient=patient_user, doctor=selected_doctor,name=name_order,phone_number=user_phone_number,data_time=Date_Appointment).save()
